# TKU Cluster Manifest - 20260525-132753

- Apply requested: `False`
- Mod name: `TKUCompatEditorPatch`
- Target game version: `1.13.378`
- Default load order: `95`
- Backup dir: `D:\Downloads\OneDrive\Documents\code\tku-update\reports\tku_editor_first\backups\cluster_manifest_20260525-132753`

## Changes

- editor source mod.json: `planned` - `E:\Games\MechWarrior5Editor\MW5Mercs\Plugins\TKUCompatEditorPatch\mod.json`
  - Manifest count: `18` -> `35`
  - TKU cluster entries: `10` -> `10`
  - Active career source entries: `0` -> `17`
  - Added entries: `17`
