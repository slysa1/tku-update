# TKU Cluster Manifest - 20260525-162032

- Apply requested: `True`
- Mod name: `TKUCompatEditorPatch`
- Target game version: `1.13.378`
- Default load order: `95`
- Backup dir: `D:\Downloads\OneDrive\Documents\code\tku-update\reports\tku_editor_first\backups\cluster_manifest_20260525-162032`

## Changes

- editor source mod.json: `updated` - `E:\Games\MechWarrior5Editor\MW5Mercs\Plugins\TKUCompatEditorPatch\mod.json`
  - Manifest count: `35` -> `36`
  - TKU cluster entries: `10` -> `10`
  - Active career source entries: `17` -> `17`
  - Active cluster diagnostic entries: `0` -> `1`
  - Added entries: `1`

## Required Cluster Assets
...
## Required Active Career Source Assets
...
## Required Active Cluster Diagnostic Assets
