...
Non-mutating probe of MW5 Mod Editor Python API names related to mod/plugin/asset authoring.

## Asset Probe

- `asset_path`: `/Game/UI/FrontEnd/StarMapPawn`
- `exists`: `True`
- `loaded`: `True`
- `class`: `Blueprint`
- `object_path`: `/Game/UI/FrontEnd/StarMapPawn.StarMapPawn`
- `blueprint_class`: `/Game/UI/FrontEnd/StarMapPawn.StarMapPawn_C`
- `cdo_path`: `/Game/UI/FrontEnd/StarMapPawn.Default__StarMapPawn_C`
- `cdo_class`: `StarMapPawn_C`
- `cdo_properties`: `{'PanBoundsHorizontal': 5500.0, 'PanBoundsVertical': 4500.0, 'ZoomDistanceList': [400.0, 550.0, 700.0, 1400.0, 1600.0, 1800.0, 3500.0], 'ZoomLevelThresholds': [2000, 1000]}`
...
- `BlendMode`
- `BlueprintCompileMode`
- `BoneModificationMode`
- `BoneTranslationRetargetingMode`
- `CameraModifier`
- `CameraModifier_CameraShake`
- `CameraProjectionMode`
- `CheatManagerVideoCaptureModeChange`
- `ChromaSDKSceneMode`
- `ClampMode`
- `ClothMassMode`
...
- `DrivenBoneModificationMode`
- `DrivenDestinationMode`
- `ECMMode`
...
- `GameModeBase`
- `GameModeName`
- `GeoAnchorComponentDebugMode`
- `HitResultGizmoFilterMode`
- `ImageComponentDebugMode`
- `InsetPolygonsMode`
- `InterpCurveMode`
- `InterpTrackMoveRotMode`
- `LerpInterpolationMode`
- `LevelVisibilityDirtyMode`
...
- `MWEventLogModel`
- `MWFinanceModel`
- `MWFinancialModelHandler`
- `MWGameMode`
- `MWInventoryModel`
- `MWLandscapeModifier`
- `MWMarketModel`
- `MWMechModelDataAsset`
- `MWMechStorageModel`
- `MWMechTraitModel`
- `MWMercCompanyModel`
- `MWMetagameObjectiveModel`
...
- `MWDestructiblePieceMaterialOverrideAsset`
- `MWMaterialOverride`
- `MaterialInstanceBasePropertyOverrides`
- `MechOverrideState`
- `MechPowerComponentOverrideChangedSig`
- `MechPowerComponentOverrideEnabledSig`
- `MechPowerComponentOverrideShutdownSig`
- `MediaPlayerOptionBooleanOverride`
- `MovieSceneBindingOverrideData`
- `MovieSceneBindingOverrides`
- `NavSystemConfigOverride`
- `NavSystemOverridePolicy`
- `NiagaraScalabilityOverrides`
- `NiagaraSystemScalabilityOverride`
- `NiagaraSystemScalabilityOverrides`
- `OnOverrideCampaignComplete`
...
### `asset`
- `AIBehaviourConfigAssetId`
- `AbcAssetImportData`
- `AcademyAssetId`
- `AchievementAssetId`
- `AkAssetBase`
- `AkAssetData`
- `AkAssetDataSwitchContainer`
- `AkAssetDataSwitchContainerData`
- `AkAssetDataWithMedia`
- `AkAssetFactory`
- `AkAssetPlatformData`
- `AkAudioAssetId`
- `AkExternalMediaAsset`
- `AkLocalizedMediaAsset`
- `AkMediaAsset`
- `AkMediaAssetData`
- `AmmoDataAssetId`
- `AnimAssetCurveFlags`
...
- `MWBlueprintGameplayTagContainer`
- `MWBlueprintUtils`
- `MWCoopPlayerSlotBlueprintUtils`
- `MWCrossplayBlueprintUtils`
...
- `InstantActionDeploymentSave`
- `MWCampaignArcActionSaveData`
- `MWGameUserSettingsSaveGame`
- `MWImportSaveWidget`
- `MWSaveGame`
- `MWSaveGameSystem`
- `MWSaveHeader`
...
- `MWSaveType`
- `MWSaveWidget`
- `MWSavedGameUserSettings`
- `MWUserSaveMetaData`
- `MagicLeapARPinSaveGame`
- `MechLoadoutSave`
- `MechlabSaveSkinError`
- `ObjectSaveData`
- `OnAsyncHandleSaveGame`
- `SaveGame`
- `SaveGameResult`
- `TimelineEventSaveData`
- `ToiSaveData`

### `cook`
- `PrimaryAssetCookRule`

## Class Members

### `EditorAssetLibrary` exists `True`
- `call_method`
- `cast`
- `checkout_asset`
- `checkout_directory`
...
### `BlueprintEditorLibrary` exists `False`

### `EditorLoadingAndSavingUtils` exists `True`
- `call_method`
- `cast`
- `export_scene`
- `get_class`
...
### `EditorLevelLibrary` exists `True`
- `call_method`
- `cast`
...
### `PluginBlueprintLibrary` exists `False`

### `ProjectPackagingSettings` exists `False`
