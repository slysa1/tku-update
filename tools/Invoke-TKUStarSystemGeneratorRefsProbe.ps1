...
$scriptPath = Join-Path $PSScriptRoot 'tku_reference_audit\ue4_probe_starsystem_generator_refs.py'
...
if (-not (Test-Path -LiteralPath $scriptPath)) {
    throw "StarSystemGenerator refs probe script not found: $scriptPath"
}
...
try {
    ...
    Write-Host "Launching MW5 Mod Editor StarSystemGenerator reference probe..."
